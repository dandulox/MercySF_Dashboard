export default {
  ...
  'accounts.reloadConfigsBtn': '⟳ Configs neu laden',
  'accounts.reloadConfigsTitle': 'Schickt die Konfiguration jedes node-zugewiesenen Accounts erneut an seinen Node — behebt Drift, bei dem das Dashboard einen Account auf einem Node führt, der ihn selbst nicht kennt. Laufende Bots werden dabei nicht neu gestartet.',
  'accounts.reloadingConfigs': 'Lade Configs neu...',
  'accounts.reloadConfigsDone': '{{succeeded}}/{{total}} synchronisiert.',
  'accounts.reloadConfigsFailed': '{{succeeded}}/{{total}} synchronisiert — fehlgeschlagen: {{names}}',
  'accounts.startAllGlobalBtn': 'Alle Accounts starten',
  'accounts.stopAllGlobalBtn': 'Alle Accounts stoppen',
  'accounts.confirmStartAllGlobal': 'Alle {{count}} Accounts starten?',
  'accounts.confirmStopAllGlobal': 'Alle {{count}} Accounts stoppen?',
